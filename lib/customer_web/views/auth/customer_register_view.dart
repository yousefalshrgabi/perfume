          ...
          child: Container(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  const Icon(Icons.person_add_alt_1, size: 60, color: Color(0xFF8B5CF6)),
                  ...
                  TextFormField(
                    ...
                    validator: (v) {
                      if (v == null || v.isEmpty) return AppStrings.get(context, 'required_field');
                      if (v.length < 6) return AppStrings.get(context, 'password_too_short');
                      return null;
                    },
                  ),
                    ...
                    builder: (context, vm, _) => SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: vm.isLoading 
                            ...
                            : Text(AppStrings.get(context, 'create_account'), style: GoogleFonts.cairo(color: Colors.white, fontSize: 18)),
                      ),
                    ),
                  ),
                  const SizedBox(height: 16),
